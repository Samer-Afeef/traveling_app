...
const tripsData = [
  Trip(
    ...
    title: 'جبال الألب',
    tripType: TripType.exploration,//استكشاف
    season: Season.winter,//موسم شتاء
    imageUrl:
    ...
    isInSummer: false, //هو في الصيف
    isForFamilies: true, //هو للعائلات
    isInWinter: true, //هو في الشتاء
  ),
  Trip(
    id: 'm2',
    categories: [
